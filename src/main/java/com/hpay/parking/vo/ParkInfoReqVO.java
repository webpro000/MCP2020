...
/**
 * @ClassName   : ParkInfoReqVO.java
 * @Description : 주차장 제공을 위한 요청정보 데이터 객체 클래스
 * @author o1488
 * @since 2019. 12. 5.
 * @version 1.0
 * @see
 ...
 * </pre>
 */
public class ParkInfoReqVO implements Serializable{
     ...
     */
    private static final long serialVersionUID = -8031473039985672596L;
    /**
     * Statements
     * (long)serialVersionUID 
     */
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    private String incarpayment_use_ny;
    @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    /** 
     * @return the incarpayment_use_ny
     * 제공 : incarpayment_use_yn
     */
    public String getIncarpayment_use_ny() {
        return incarpayment_use_ny;
    }
    /**
     * @param incarpayment_use_ny the incarpayment_use_ny to set
     */
    public void setIncarpayment_use_ny(String incarpayment_use_ny) {
        this.incarpayment_use_ny = incarpayment_use_ny;
    }
     ...
     */
    public JSONArray getPark_echarge_list() {
        return park_echarge_list;
    }
    /**
     * @param park_echarge_list the park_echarge_list to set
     */
    public void setPark_echarge_list(JSONArray park_echarge_list) {
